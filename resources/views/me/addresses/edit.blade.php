...
@section('content')
    <form action="{{ route('me.addresses.update', ['id' => $address->id]) }}" method="post">
        @method('PUT')
        @csrf
        ...
        <div class="row mb-3">
            <div class="col-9 col-md-6">
                <div>
                    ...
                    <input value="{{ $address->street }}" type="text" class="form-control" id="street"
            ...
            <div class="col-3 col-md-2">
                <div>
                    ...
                    <input value="{{ $address->number }}" type="text" class="form-control" id="number"
            ...
            <div class="col-3 col-md-1">
                <div>
                    ...
                    <input value="{{ $address->uf }}" type="text" class="form-control" id="uf" name="uf"
        ...
        <div class="form-floating mb-3">
            <textarea id="complement" name="complement" class="form-control" placeholder="Digite algumas informações adicionais...">
                {{ $address->complement }}
            </textarea>
