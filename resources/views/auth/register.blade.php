                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="row mb-3">
                                <label for="document_id" class="col-md-4 col-form-label text-md-end">
                                    Documento (CPF ou CNPJ)
                                </label>

                                <div class="col-md-6">
                                    <input id="document_id" type="text"
                                        class="form-control @error('document_id') is-invalid @enderror" name="document_id"
